  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.dbsInfo.isRegisteredWithUpdateService) {
        if (
          !formData.dbsInfo.name ||
          !formData.dbsInfo.dateOfBirth ||
          !formData.dbsInfo.certificateNumber
        ) {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              {formData.references.map((reference, index) => (
                <div
                  key={index}
                  className="border border-gray-600 bg-gray-700 p-6 rounded-lg space-y-4"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-700 border border-gray-600 p-6 rounded-lg">
                <p className="text-sm text-gray-200 leading-relaxed">
                  ...
                  that any false statements or omissions may result in rejection
                  of my application or dismissal if employed. I authorize Crown
                  Cars to verify all information provided and conduct relevant
                  background checks.
                </p>
              </div>
              <label className="flex items-center cursor-pointer">

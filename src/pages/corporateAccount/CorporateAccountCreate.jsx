...
import { createCorporateAccount } from "@services/corporateAccount";
import { corporateAccountValidationSchema } from "@utils/validations";
import { ThemeContext } from "@context/ThemeContext";

const CorporateAccountCreate = () => {
          ...
          <div className="px-4 py-6 sm:p-8">
            <div className="mb-8">
              ...
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200">
                Create a new corporate account in the system.
              </p>
            </div>
...
export default CorporateAccountCreate;
